...
def create_vendor(request):
    if request.method == 'POST':
        ...
        if vendor_form.is_valid():
            print("vendor_form    start    ================ ")
            vendor = vendor_form.save()
            
            if sequence_formset.is_valid():
                print("sequence_formset    start    ================ ")
